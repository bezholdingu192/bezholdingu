...
public class DecoderCountry {
    ...
    public static ZemeData getCompanyCountry(String barcode)
    {
        ...
        if ( (iCode >= 0 && iCode <= 19) || (iCode >= 30 && iCode <= 39) || (iCode >= 60 && iCode <= 139) )
            ...
            return new ZemeData(iCode,  Kategorie.RUSKO,"Rusko", "z Ruska");
        else if (iCode == 470)
            ...
            return new ZemeData(iCode,  Kategorie.BELORUSKO,"Bělorusko", "z Běloruska");
        else if (iCode == 482)
...
class ZemeData {
    int kod;
    DecoderCountry.Kategorie kategorie;
    String nazev;
    String nazevSklonovany;

    public ZemeData(int _kod, DecoderCountry.Kategorie _kategorie, String _nazev, String _nazevSklonovany) {
        kod = _kod;
